	...
	$.tc_replace_object_values = function ( obj1, obj2 ) {
		for ( var x in obj1 ) {
			for ( var attr in obj1[ x ] ) {
				if ( obj2[ x ].hasOwnProperty( attr ) && (undefined !== obj2[ x ] && undefined !== obj2[ x ][ attr ]) ) {
	...
	$.tc_maybe_copy_object_values = function ( obj1, obj2 ) {
		for ( var x in obj2 ) {
			for ( var attr in obj2[ x ] ) {
				if ( obj2[ x ].hasOwnProperty( attr ) && undefined !== obj2[ x ][ attr ] && (undefined === obj1[ x ] || undefined === obj1[ x ][ attr ]) ) {
					if ( undefined === obj1[ x ] ) {
						obj1[ x ] = {};
					}
					obj1[ x ][ attr ] = obj2[ x ][ attr ];
