	...
	public function _get_setting_cart( $setting, $label ) {
		return array(
			...
			array(
				...
				'desc'    => '<span>' . __( 'Enable this if the product have a lot of options.', 'woocommerce-tm-extra-product-options' ) . '</span>',
	...
	public function _get_setting_string( $setting, $label ) {
		return array(
			...
			(tc_woocommerce_subscriptions_check()) ?
				array(
					'title'    => __( 'Subscription sing up fee text', 'woocommerce-tm-extra-product-options' ),
					'desc_tip' => '<span>' . __( 'Enter the Subscription sing up fee text or leave blank for default.', 'woocommerce-tm-extra-product-options' ) . '</span>',
