...
final class TM_EPO_COMPATIBILITY_woothemes_subscriptions {
	...
	public function add_compatibility() {
		...
		add_filter( 'wcs_renewal_order_items', array( $this, 'tm_woocommerce_subscriptions_renewal_order_items' ), 10, 5 );
	}
	...
	/** WooCommerce Subscriptions (woothemes) support - Calculates the extra Subscription sing up fee **/
